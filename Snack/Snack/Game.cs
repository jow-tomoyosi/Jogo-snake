    ...
    internal class Game
    {
        ...
        public void Tick()
        {
            ...
            for (int i = 0; i < Snake.Length; i++) {
                if(i == 0)
                {
                    bitmapGraph.FillEllipse(new SolidBrush(ColorTranslator.FromHtml("#14540d")), (Snake.Location[i].X * 15), (Snake.Location[i].Y * 15), 15, 15);
                } else
                {
                    bitmapGraph.FillEllipse(new SolidBrush(ColorTranslator.FromHtml("#469536")), (Snake.Location[i].X * 15), (Snake.Location[i].Y * 15), 15, 15);
                }
        ...
        public void GameOver()
        {
            ...
            MessageBox.Show("Game Over: " + pontos + " pontos!");
        }
    }
}
